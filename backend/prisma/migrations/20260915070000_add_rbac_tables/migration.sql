...
CREATE TABLE "roles" (
    ...
    "isAssignableOnRegistration" BOOLEAN NOT NULL DEFAULT false,
...
CREATE UNIQUE INDEX "UserRole_userId_roleId_active_unique" ON "UserRole"("userId", "roleId") WHERE "revokedAt" IS NULL;
