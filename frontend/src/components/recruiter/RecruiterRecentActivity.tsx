...
interface RecruiterRecentActivityProps {
  title?: string;
  onViewAll?: () => void;
...
const defaultActivities: RecruiterActivityItem[] = [
  {
    id: "1",
    type: "viewed",
    title: (
      <span>
        <strong className="font-semibold text-slate-900">Michael Carter</strong>{" "}
        viewed your job post for{" "}
  ...
  },
  {
    ...
    title: (
      <span>
        <strong className="font-semibold text-slate-900">Alex Johnson</strong>{" "}
  ...
  },
  {
    ...
    title: (
      <span>
        ...
        <strong className="font-semibold text-slate-900">Emily Chen</strong> for{" "}
        <strong className="font-semibold text-slate-900">
          Shopify Store Setup
        </strong>
      </span>
...
export const RecruiterRecentActivity: React.FC<
  RecruiterRecentActivityProps
> = ({
  ...
  const renderIcon = (type: RecruiterActivityItem["type"]) => {
    switch (type) {
      case "viewed":
        return (
...
export default RecruiterRecentActivity;
